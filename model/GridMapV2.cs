...
//namespace HPF.model {
//    public record Gate(Node Origin, List<Gate> Connections) {
...
//                var existing = chunk.Gates.FirstOrDefault(g => g.Origin.Pos == node.Pos);
//                if (existing != null)
//                    return existing;
...
//                            if (seen.Add(gate))
//                                yield return gate.Origin;
//                    }
//                }
//            }

//            internal GridMapV2 InitConnections(IAlgo algo) {
//                for (int i = 0; i < ChunksV2.GetLength(0); i++) {
//                    for (int j = 0; j < ChunksV2.GetLength(1); j++) {
...
//            //    return nodes;
//            //}
//            public GridMapV2 ConnectStartGate(IAlgo algo) {
//                if (start == null) {
//                    throw new Exception();
//                }
//                ConnectNodeToGates(start, algo);
//                return this;
//            }
//            public GridMapV2 ConnectGoalGate(IAlgo algo) {
//                if (goal == null) {
//                    throw new Exception();
//                }
//                ConnectNodeToGates(goal, algo);
//                return this;
//            }
//            private void ConnectNodeToGates(Vector2 nodePos, IAlgo algo) {
...
//                    throw new Exception();
//                }
//                var newNode = new Node(nodePos, []);
//                chunk.Gates.Add(newNode);

//                foreach (var gate in gates) {
//                    if (gate.Equals(newNode))
//                        continue;
//                    var path = algo.FindGoal(node, gate);
//                    if (path.nodes.Count > 0) {
//                        newNode.Connections.Add(gate);
//                        gate.Connections.Add(newNode);
//                    }
//                }
//            }
...
//                var startGate = startChunkV2.Gates.Find(gate => gate.Pos == start);
//                var goalGate = startChunkV2.Gates.Find(gate => gate.Pos == goal);

//                FinalPath ChunkV2Path = algo.FindGoal(startGate, goalGate);
